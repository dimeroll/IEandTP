...
function updateCustomer() {
    const custId = document.getElementById('edit-id').value;
...
function _displayCustomers(data) {
    ...
    data.forEach(customer => {
        ...
        editButton.setAttribute('onclick', `displayEditForm(${customer.CustomerId})`);

        let deleteButton = button.cloneNode(false);
        deleteButton.innerText = 'Delete';
        deleteButton.setAttribute('onclick', `deleteCustomer(${customer.CustomerId})`);
